...
use Civi\RemoteActivity\Api4\Action\Remote\Traits\RemoteActivityActionContactIdRequiredTrait;
use Civi\RemoteActivity\Event\Remote\DAOGetEvent;
use Civi\RemoteActivity\Event\Remote\ActivityEvents;
use Civi\RemoteTools\Api4\Action\EventDAOGetAction;

class DAOGetAction extends EventDAOGetAction implements RemoteActivityActionInterface {

  use RemoteActivityActionContactIdRequiredTrait;
